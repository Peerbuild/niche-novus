  ...
  return (
    <section className="relative min-h-[98svh] ">
      <div className="absolute w-full -z-10  left-1/2 -top-40 -translate-x-1/2 min-h-[inherit] inset-0 overflow-hidden">
        <div className="bg-gradient-to-t from-background z-10 to-background/60 absolute w-full h-full inset-0"></div>
        <video
          src="/bg/bg-1.mp4"
          autoPlay
          muted
          loop
          className="object-cover hidden lg:block h-full w-full"
        />
        <Image
          src={"/bg/bg-1.jpg"}
          alt="herobg"
          width={1200}
          height={1000}
          className="w-full h-full object-cover translate-y-20 lg:hidden"
        />
      </div>
      <main className="flex relative flex-col container gap-10 md:gap-6 pt-16  md:h-[30rem] px-6 lg:px-12 justify-center 2xl:max-w-screen-xl  mx-auto min-h-[inherit]">
        <div className="max-w-56 space-y-20 lg:pr-20 md:self-end">
